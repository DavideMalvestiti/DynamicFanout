...
do for [i=0:14] {
set term wxt 0 size 650,450 position 0,0
...
set term wxt 1 size 650,450 position 700,0
plot 'base.dat' notitle with linespoints ls 1 , 'receiver'.i.'.dat' notitle with linespoints ls 2 , 'bleState'.i.'.dat' using 1:2:3 notitle with linespoints ls 3 , NaN with point pt 5 ps 2 lc rgb "black" title "Standby", NaN with points pt 5 ps 2 lc rgb "green" title "Scanning", NaN with points pt 5 ps 2 lc rgb "red" title "Initiating", NaN with points pt 5 ps 2 lc rgb "yellow" title "Advertising", NaN with points pt 5 ps 2 lc rgb "blue" title "Connection"
